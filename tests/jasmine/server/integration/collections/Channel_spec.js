describe('Channel collection', function() {
  ...
  describe('description field', function() {
    ...
    it('requires that the description field is a string', function() {
      let channel = new Channel({
        title: 'Query Test',
        query: 42
      });
    ...
    it('requires that the description field is at most 250 characters', function() {
      let channel = new Channel({
        title: 'Query Test',
        // 250 characters
  ...
  describe('#getLatest', function() {
    ...
    it('should provide a default limit to the description', function() {
      Channel.getLatest();
